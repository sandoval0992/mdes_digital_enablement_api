...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new MdesDigitalEnablementApi.TokenInfo();
  });
  ...
  describe('TokenInfo', function() {
    it('should create an instance of TokenInfo', function() {
      ...
      //var instance = new MdesDigitalEnablementApi.TokenInfo();
      //expect(instance).to.be.a(MdesDigitalEnablementApi.TokenInfo);
    });
